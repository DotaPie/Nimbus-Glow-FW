...
/* What is affected by development define?
 *
 * 1) Soft AP SSID is always Nimbus Glow #1234 and Soft AP PWD is always 12345678, instead of being randomly generated on each factory reset.
